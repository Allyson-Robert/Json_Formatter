...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.quotes_button = QtWidgets.QPushButton(self.centralwidget)
        self.quotes_button.setGeometry(QtCore.QRect(450, 110, 131, 31))
        self.quotes_button.setObjectName("quotes_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.quotes_button.setText(_translate("MainWindow", "Fix Quotes"))
